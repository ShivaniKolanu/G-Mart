...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | G-Mart</title>
...
<body>
    <main>
    <nav class="navbar navbar-expand-lg navbar-dark bg-gradient" id="topNavBar" style="background:#30D5C8">
        <div class="container" >
            ...
            <?php else: ?>
                <a href="javascript:void(0)" id="login-btn" class="text-decoration-none" style="color:white">Login</a>
                |
                <a href="javascript:void(0)" id="register-btn" class="text-decoration-none" style="color:white">Register</a>
            <?php endif; ?>
